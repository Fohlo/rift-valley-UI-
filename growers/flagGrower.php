...
$tm = $grower_i2['Message'];
	$ti = $grower_i2['ExceptionMessage'];
		...
		$error = "";//"Error: call to URL $url failed with status $status, response $booking_id";		$_SESSION['capnum'] = "Enter the correct Grower Number!";
		$_SESSION['capnums'] = "";
		$gname = $_SESSION['capnum'];
$gno = $_SESSION['capnums'];
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Flag Growers</li>
            						</ul>
                                </div>
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		<textarea class="form-control" name="comments" id="comments"  placeholder="Add Summary Comments" ></textarea>
              ...
              <div class="card-footer"  align="left">
                ...
                <button type="submit"  name="addbooking" class="btn btn-sm btn-primary"><i class="fa fa-check"></i>Flag Grower</button>
